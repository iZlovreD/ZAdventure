...
ret.area['maze variant_0'] = ""
	...
	,ScriptForAll = function(rndroll, game, surface, force, area, center, namelist, entitylist, areadata)
		...
		for _,entity in pairs(entitylist) do if entity and entity.valid and entity.prototype.name == "iron-chest" then
			...
			if variations[2] < 0 then
				table.insert(areadata.prize, { name=variations[1], count=1 })
				
			elseif variations[2] ~= 0 or (variations[2] == 0 and Rnd() % 10 ~= 0) then 
				for i=1, math.min(16, math.max(variations[2], Rnd() % variations[3])), 1 do
					table.insert(areadata.prize, variations[1])
				end
			end
...
ret.area['maze variant_7'] = {
	...
	,Events = {
		...
		[defines.events.on_tick] = function(event, ad, game)
			...
			if ad.looted and not ad.destroyed then
				for _,ent in pairs(ad.surface.find_entities_filtered{area=ad.area,name={"iron-chest","gate","stone-wall"}}) do
					if ent and ent.valid then ent.die('neutral') end
				end
				ad.destroyed = true
			end
...
ret.area['occupied base'] = {
	...
	,ScriptForAll = function(rndroll, game, surface, force, area, center, namelist, entitylist, areadata)
		...
		surface.set_multi_command{unit_count=1, force=force, unit_search_distance=28,
			command={type=defines.command.build_base, destination=Position.offset(center, -29, -25),distraction=defines.distraction.none, ignore_planner=true}}
		surface.set_multi_command{force=force, command={type=defines.command.wander}}
...
ret.area['inventive station'] = {
	...
	,ScriptForEach = function(rndroll, game, surface, force, area, center, entity, namelist, locstore, areadata)
		...
		elseif entity and entity.valid and entity.prototype.name == "stack-inserter" then
			...
			entity.inserter_stack_size_override = 99
		...
		[defines.events.on_tick] = function(event, ad, game)
			...
			local function ChangeRecipe()
				...
				if IntegrityCheck('chest') then
					...
					ad.inserter.entity.inserter_stack_size_override = 99
							...
							for _,reagent in pairs(ad.decider.current_recipe.ingredients) do
								...
								if reagent.type == 'item' then
									...
									for _,r in pairs(game.recipe_prototypes) do
										if not found
										and not r.name:find('barrel') and not r.name:find('creative')
